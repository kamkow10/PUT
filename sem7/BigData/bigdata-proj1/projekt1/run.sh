...
hadoop jar countAndSumOfRatesMovies.jar CountAndSumOfRatesMovies input/datasource1 output_mr3
...
#przykład dla Hive
hive --hivevar username=$USER -f topThreeAvgRatesForEachYear.hql
